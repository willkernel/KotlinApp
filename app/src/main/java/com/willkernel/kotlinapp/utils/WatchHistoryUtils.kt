...
class WatchHistoryUtils {
    ...
    companion object {
         ...
         * 保存在手机里面的文件名
         */
        private val FILE_NAME = "kotlin_file"
        ...
        fun put(context: Context, key: String, `object`: Any) {
            ...
            Companion.SharedPreferencesCompat.apply(editor)
        }
        ...
        fun putObject(
            fileName: String, context: Context, `object`: Any?,
            key: String
        ): Boolean {
            val sp = context.getSharedPreferences(
                fileName,
        ...
        fun getObject(fileName: String, context: Context, key: String): Any? {
            val sharePre = context.getSharedPreferences(
                fileName,
                Context.MODE_PRIVATE
            )
            try {
